...
def parse_h5(human_h5, yumi_h5):
    # get data for yumi-gym
    hf = h5py.File(yumi_h5, 'r')
    ...
    for key in h5_file.keys():
        ...
        def run(t):
            ...
            # yumi-gym step
            action = l_joint_angle[t].tolist() + r_joint_angle[t].tolist() + l_hand_angle[t].tolist() + r_hand_angle[
                t].tolist()
...
if __name__ == '__main__':
    ...
    parse_h5('/home/yu/PycharmProjects/MotionTransfer-master-Yu-comment/test.h5',
             '/home/yu/PycharmProjects/neural-retargeting/saved/h5/inference.h5')
    env.close()